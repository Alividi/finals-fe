import 'package:finals_fe/core/controllers/login_provider.dart';
import 'package:finals_fe/core/controllers/logout_provider.dart';
import 'package:finals_fe/core/controllers/save_user_provider.dart';
...
class Authentication extends _$Authentication {
  ...
  Future<void> login({
    ...
    final result = await login(LoginParams(username: username, password: password));
    result.fold((error) {
  ...
  Future<void> logout({required Function onSuccess, required Function onError}) async {
    state = const AsyncLoading();
